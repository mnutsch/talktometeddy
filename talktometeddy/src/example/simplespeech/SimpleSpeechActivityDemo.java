...
public class SimpleSpeechActivityDemo extends Activity implements OnInitListener {
    ...
    private String apikey = "962b2d2b8e72dc6771bca613d49b46fb"; //used by SentenceRecognition.com API
    ...
    private String task6A1 = "Hey Kiddoe! Press my belly and talk to me.";
    ...
    private String task7A = "I know about colors, numbers, animal sounds, the alphabet, funny jokes and songs.";
    ...
    private String task8C1 = "What do call a pig that knows karate? Pork chops!";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        heartSpeakButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
            	stopTTS(); //stops the text to speech if running
				...
				try {
				    ...
				    EasyTracker.getTracker().sendEvent("error_message", "general", "speech_to_text_not_supported", longitem);
				}
			}
        });
    ...
    **/
    ...
    private void handleRecognition(String speechText) {
		...
		try {
			...
			e1.printStackTrace();
			EasyTracker.getTracker().sendEvent("error", "general", "sentencerecognition_api_url_error", longitem);
		}
		...
		try {
			...
			if(promptScore < 35)
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "(unrecognized)", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "prime colors", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "teach count numbers", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "sounds do animals make", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "sing me a song", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "teach me alphabet", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "hi talking teddy", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "what do you know", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "tell me a funny joke", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "what is your name", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "how old are you", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "who is your best friend", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "where are you from", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "favorite color", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "can we be friends", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "i love you teddy", longitem); //Google Analytics event
			...
			{
				EasyTracker.getTracker().sendEvent("conversation", "user_statement", "what do you know (default)", longitem); //Google Analytics event
